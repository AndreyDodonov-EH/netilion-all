...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Tenants();
  });
  ...
  describe('Tenants', function() {
    it('should create an instance of Tenants', function() {
      // uncomment below and update the code to test Tenants
      //var instance = new NetilionApiDocumentation.Tenants();
      //expect(instance).to.be.a(NetilionApiDocumentation.Tenants);
    });
