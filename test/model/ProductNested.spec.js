...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.ProductNested();
  });
  ...
  describe('ProductNested', function() {
    it('should create an instance of ProductNested', function() {
      // uncomment below and update the code to test ProductNested
      //var instance = new NetilionApiDocumentation.ProductNested();
      //expect(instance).to.be.a(NetilionApiDocumentation.ProductNested);
    });
