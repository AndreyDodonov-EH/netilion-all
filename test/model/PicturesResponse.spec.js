...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.PicturesResponse();
  });
  ...
  describe('PicturesResponse', function() {
    it('should create an instance of PicturesResponse', function() {
      // uncomment below and update the code to test PicturesResponse
      //var instance = new NetilionApiDocumentation.PicturesResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.PicturesResponse);
    });
