...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.SoftwareResponse();
  });
  ...
  describe('SoftwareResponse', function() {
    it('should create an instance of SoftwareResponse', function() {
      // uncomment below and update the code to test SoftwareResponse
      //var instance = new NetilionApiDocumentation.SoftwareResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.SoftwareResponse);
    });
    ...
    it('should have the property softwareType (base name: "software_type")', function() {
