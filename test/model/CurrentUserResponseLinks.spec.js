...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.CurrentUserResponseLinks();
  });
  ...
  describe('CurrentUserResponseLinks', function() {
    it('should create an instance of CurrentUserResponseLinks', function() {
      // uncomment below and update the code to test CurrentUserResponseLinks
      //var instance = new NetilionApiDocumentation.CurrentUserResponseLinks();
      //expect(instance).to.be.a(NetilionApiDocumentation.CurrentUserResponseLinks);
    });
