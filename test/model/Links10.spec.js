...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Links10();
  });
  ...
  describe('Links10', function() {
    it('should create an instance of Links10', function() {
      // uncomment below and update the code to test Links10
      //var instance = new NetilionApiDocumentation.Links10();
      //expect(instance).to.be.a(NetilionApiDocumentation.Links10);
    });
