...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.AssetHistoryBase();
  });
  ...
  describe('AssetHistoryBase', function() {
    it('should create an instance of AssetHistoryBase', function() {
      // uncomment below and update the code to test AssetHistoryBase
      //var instance = new NetilionApiDocumentation.AssetHistoryBase();
      //expect(instance).to.be.a(NetilionApiDocumentation.AssetHistoryBase);
    });
