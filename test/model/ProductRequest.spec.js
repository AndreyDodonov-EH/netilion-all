...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.ProductRequest();
  });
  ...
  describe('ProductRequest', function() {
    it('should create an instance of ProductRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.ProductRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.ProductRequest);
    });
