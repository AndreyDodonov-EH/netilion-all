...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.EventRequest();
  });
  ...
  describe('EventRequest', function() {
    it('should create an instance of EventRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.EventRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.EventRequest);
    });
