...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APISubscriptionResponse();
  });
  ...
  describe('APISubscriptionResponse', function() {
    it('should create an instance of APISubscriptionResponse', function() {
      // uncomment below and update the code to test APISubscriptionResponse
      //var instance = new NetilionApiDocumentation.APISubscriptionResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.APISubscriptionResponse);
    });
