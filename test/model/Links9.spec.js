...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Links9();
  });
  ...
  describe('Links9', function() {
    it('should create an instance of Links9', function() {
      // uncomment below and update the code to test Links9
      //var instance = new NetilionApiDocumentation.Links9();
      //expect(instance).to.be.a(NetilionApiDocumentation.Links9);
    });
