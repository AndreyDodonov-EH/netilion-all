...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.UserResponseLinks();
  });
  ...
  describe('UserResponseLinks', function() {
    it('should create an instance of UserResponseLinks', function() {
      ...
      //var instance = new NetilionApiDocumentation.UserResponseLinks();
      //expect(instance).to.be.a(NetilionApiDocumentation.UserResponseLinks);
    });
