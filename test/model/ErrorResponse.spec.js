...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instance = new NetilionApiDocumentation.ErrorResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.ErrorResponse);
    });
