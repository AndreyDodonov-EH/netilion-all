...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APIKeysResponse();
  });
  ...
  describe('APIKeysResponse', function() {
    it('should create an instance of APIKeysResponse', function() {
      // uncomment below and update the code to test APIKeysResponse
      //var instance = new NetilionApiDocumentation.APIKeysResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.APIKeysResponse);
    });
