...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Notifications();
  });
  ...
  describe('Notifications', function() {
    it('should create an instance of Notifications', function() {
      ...
      //var instance = new NetilionApiDocumentation.Notifications();
      //expect(instance).to.be.a(NetilionApiDocumentation.Notifications);
    });
