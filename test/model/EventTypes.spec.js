...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.EventTypes();
  });
  ...
  describe('EventTypes', function() {
    it('should create an instance of EventTypes', function() {
      ...
      //var instance = new NetilionApiDocumentation.EventTypes();
      //expect(instance).to.be.a(NetilionApiDocumentation.EventTypes);
    });
