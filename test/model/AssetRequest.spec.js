...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.AssetRequest();
  });
  ...
  describe('AssetRequest', function() {
    it('should create an instance of AssetRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.AssetRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.AssetRequest);
    });
