...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.EventResponse();
  });
  ...
  describe('EventResponse', function() {
    it('should create an instance of EventResponse', function() {
      ...
      //var instance = new NetilionApiDocumentation.EventResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.EventResponse);
    });
