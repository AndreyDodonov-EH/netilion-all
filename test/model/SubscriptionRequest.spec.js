...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.SubscriptionRequest();
  });
  ...
  describe('SubscriptionRequest', function() {
    it('should create an instance of SubscriptionRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.SubscriptionRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.SubscriptionRequest);
    });
