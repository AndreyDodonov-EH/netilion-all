...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Permissions();
  });
  ...
  describe('Permissions', function() {
    it('should create an instance of Permissions', function() {
      ...
      //var instance = new NetilionApiDocumentation.Permissions();
      //expect(instance).to.be.a(NetilionApiDocumentation.Permissions);
    });
