...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.RequestUser();
  });
  ...
  describe('RequestUser', function() {
    it('should create an instance of RequestUser', function() {
      // uncomment below and update the code to test RequestUser
      //var instance = new NetilionApiDocumentation.RequestUser();
      //expect(instance).to.be.a(NetilionApiDocumentation.RequestUser);
    });
