...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.PermissionBase();
  });
  ...
  describe('PermissionBase', function() {
    it('should create an instance of PermissionBase', function() {
      // uncomment below and update the code to test PermissionBase
      //var instance = new NetilionApiDocumentation.PermissionBase();
      //expect(instance).to.be.a(NetilionApiDocumentation.PermissionBase);
    });
