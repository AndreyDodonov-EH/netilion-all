...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Companies1();
  });
  ...
  describe('Companies1', function() {
    it('should create an instance of Companies1', function() {
      // uncomment below and update the code to test Companies1
      //var instance = new NetilionApiDocumentation.Companies1();
      //expect(instance).to.be.a(NetilionApiDocumentation.Companies1);
    });
