...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APIKeyRequest();
  });
  ...
  describe('APIKeyRequest', function() {
    it('should create an instance of APIKeyRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.APIKeyRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.APIKeyRequest);
    });
