...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.DocumentResponse();
  });
  ...
  describe('DocumentResponse', function() {
    it('should create an instance of DocumentResponse', function() {
      ...
      //var instance = new NetilionApiDocumentation.DocumentResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.DocumentResponse);
    });
