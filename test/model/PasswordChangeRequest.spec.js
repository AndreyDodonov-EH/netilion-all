...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.PasswordChangeRequest();
  });
  ...
  describe('PasswordChangeRequest', function() {
    it('should create an instance of PasswordChangeRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.PasswordChangeRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.PasswordChangeRequest);
    });
