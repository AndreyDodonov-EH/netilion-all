...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APISubscriptionRequest();
  });
  ...
  describe('APISubscriptionRequest', function() {
    it('should create an instance of APISubscriptionRequest', function() {
      // uncomment below and update the code to test APISubscriptionRequest
      //var instance = new NetilionApiDocumentation.APISubscriptionRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.APISubscriptionRequest);
    });
