...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.NodesResponse();
  });
  ...
  describe('NodesResponse', function() {
    it('should create an instance of NodesResponse', function() {
      // uncomment below and update the code to test NodesResponse
      //var instance = new NetilionApiDocumentation.NodesResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.NodesResponse);
    });
