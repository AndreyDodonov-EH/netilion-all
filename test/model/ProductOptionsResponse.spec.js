...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.ProductOptionsResponse();
  });
  ...
  describe('ProductOptionsResponse', function() {
    it('should create an instance of ProductOptionsResponse', function() {
      // uncomment below and update the code to test ProductOptionsResponse
      //var instance = new NetilionApiDocumentation.ProductOptionsResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.ProductOptionsResponse);
    });
