...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.DocumentRequest();
  });
  ...
  describe('DocumentRequest', function() {
    it('should create an instance of DocumentRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.DocumentRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.DocumentRequest);
    });
