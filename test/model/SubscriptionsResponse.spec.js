...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.SubscriptionsResponse();
  });
  ...
  describe('SubscriptionsResponse', function() {
    it('should create an instance of SubscriptionsResponse', function() {
      ...
      //var instance = new NetilionApiDocumentation.SubscriptionsResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.SubscriptionsResponse);
    });
