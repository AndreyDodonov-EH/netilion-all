...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Links4();
  });
  ...
  describe('Links4', function() {
    it('should create an instance of Links4', function() {
      // uncomment below and update the code to test Links4
      //var instance = new NetilionApiDocumentation.Links4();
      //expect(instance).to.be.a(NetilionApiDocumentation.Links4);
    });
