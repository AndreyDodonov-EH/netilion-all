...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.AssetValuesPagination();
  });
  ...
  describe('AssetValuesPagination', function() {
    it('should create an instance of AssetValuesPagination', function() {
      // uncomment below and update the code to test AssetValuesPagination
      //var instance = new NetilionApiDocumentation.AssetValuesPagination();
      //expect(instance).to.be.a(NetilionApiDocumentation.AssetValuesPagination);
    });
