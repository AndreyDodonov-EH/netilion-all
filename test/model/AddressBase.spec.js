...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.AddressBase();
  });
  ...
  describe('AddressBase', function() {
    it('should create an instance of AddressBase', function() {
      // uncomment below and update the code to test AddressBase
      //var instance = new NetilionApiDocumentation.AddressBase();
      //expect(instance).to.be.a(NetilionApiDocumentation.AddressBase);
    });
