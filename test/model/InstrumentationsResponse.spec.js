...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.InstrumentationsResponse();
  });
  ...
  describe('InstrumentationsResponse', function() {
    it('should create an instance of InstrumentationsResponse', function() {
      // uncomment below and update the code to test InstrumentationsResponse
      //var instance = new NetilionApiDocumentation.InstrumentationsResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.InstrumentationsResponse);
    });
