...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.QuotationResponse();
  });
  ...
  describe('QuotationResponse', function() {
    it('should create an instance of QuotationResponse', function() {
      // uncomment below and update the code to test QuotationResponse
      //var instance = new NetilionApiDocumentation.QuotationResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.QuotationResponse);
    });
