...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.TenantRequest();
  });
  ...
  describe('TenantRequest', function() {
    it('should create an instance of TenantRequest', function() {
      ...
      //var instance = new NetilionApiDocumentation.TenantRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.TenantRequest);
    });
