...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Products();
  });
  ...
  describe('Products', function() {
    it('should create an instance of Products', function() {
      ...
      //var instance = new NetilionApiDocumentation.Products();
      //expect(instance).to.be.a(NetilionApiDocumentation.Products);
    });
