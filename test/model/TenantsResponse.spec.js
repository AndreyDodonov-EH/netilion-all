...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.TenantsResponse();
  });
  ...
  describe('TenantsResponse', function() {
    it('should create an instance of TenantsResponse', function() {
      // uncomment below and update the code to test TenantsResponse
      //var instance = new NetilionApiDocumentation.TenantsResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.TenantsResponse);
    });
