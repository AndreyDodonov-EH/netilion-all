...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Companies();
  });
  ...
  describe('Companies', function() {
    it('should create an instance of Companies', function() {
      ...
      //var instance = new NetilionApiDocumentation.Companies();
      //expect(instance).to.be.a(NetilionApiDocumentation.Companies);
    });
