...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Causes();
  });
  ...
  describe('Causes', function() {
    it('should create an instance of Causes', function() {
      // uncomment below and update the code to test Causes
      //var instance = new NetilionApiDocumentation.Causes();
      //expect(instance).to.be.a(NetilionApiDocumentation.Causes);
    });
