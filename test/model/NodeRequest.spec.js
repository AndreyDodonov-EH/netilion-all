...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.NodeRequest();
  });
  ...
  describe('NodeRequest', function() {
    it('should create an instance of NodeRequest', function() {
      // uncomment below and update the code to test NodeRequest
      //var instance = new NetilionApiDocumentation.NodeRequest();
      //expect(instance).to.be.a(NetilionApiDocumentation.NodeRequest);
    });
