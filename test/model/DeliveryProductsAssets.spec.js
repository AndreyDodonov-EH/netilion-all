...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.DeliveryProductsAssets();
  });
  ...
  describe('DeliveryProductsAssets', function() {
    it('should create an instance of DeliveryProductsAssets', function() {
      // uncomment below and update the code to test DeliveryProductsAssets
      //var instance = new NetilionApiDocumentation.DeliveryProductsAssets();
      //expect(instance).to.be.a(NetilionApiDocumentation.DeliveryProductsAssets);
    });
