...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.PictureResponse();
  });
  ...
  describe('PictureResponse', function() {
    it('should create an instance of PictureResponse', function() {
      // uncomment below and update the code to test PictureResponse
      //var instance = new NetilionApiDocumentation.PictureResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.PictureResponse);
    });
