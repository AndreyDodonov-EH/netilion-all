...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.TechnicalUserCreateResponseLinks();
  });
  ...
  describe('TechnicalUserCreateResponseLinks', function() {
    it('should create an instance of TechnicalUserCreateResponseLinks', function() {
      // uncomment below and update the code to test TechnicalUserCreateResponseLinks
      //var instance = new NetilionApiDocumentation.TechnicalUserCreateResponseLinks();
      //expect(instance).to.be.a(NetilionApiDocumentation.TechnicalUserCreateResponseLinks);
    });
