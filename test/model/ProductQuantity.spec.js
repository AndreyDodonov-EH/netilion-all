...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.ProductQuantity();
  });
  ...
  describe('ProductQuantity', function() {
    it('should create an instance of ProductQuantity', function() {
      ...
      //var instance = new NetilionApiDocumentation.ProductQuantity();
      //expect(instance).to.be.a(NetilionApiDocumentation.ProductQuantity);
    });
