...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.AssetIDs();
  });
  ...
  describe('AssetIDs', function() {
    it('should create an instance of AssetIDs', function() {
      // uncomment below and update the code to test AssetIDs
      //var instance = new NetilionApiDocumentation.AssetIDs();
      //expect(instance).to.be.a(NetilionApiDocumentation.AssetIDs);
    });
