...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.DeliveryResponse();
  });
  ...
  describe('DeliveryResponse', function() {
    it('should create an instance of DeliveryResponse', function() {
      // uncomment below and update the code to test DeliveryResponse
      //var instance = new NetilionApiDocumentation.DeliveryResponse();
      //expect(instance).to.be.a(NetilionApiDocumentation.DeliveryResponse);
    });
