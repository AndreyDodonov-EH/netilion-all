...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.Links15();
  });
  ...
  describe('Links15', function() {
    it('should create an instance of Links15', function() {
      // uncomment below and update the code to test Links15
