...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.NodeIDs();
  });
  ...
  describe('NodeIDs', function() {
    it('should create an instance of NodeIDs', function() {
      // uncomment below and update the code to test NodeIDs
      //var instance = new NetilionApiDocumentation.NodeIDs();
      //expect(instance).to.be.a(NetilionApiDocumentation.NodeIDs);
    });
