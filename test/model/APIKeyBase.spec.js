...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APIKeyBase();
  });
  ...
  describe('APIKeyBase', function() {
    it('should create an instance of APIKeyBase', function() {
      ...
      //var instance = new NetilionApiDocumentation.APIKeyBase();
      //expect(instance).to.be.a(NetilionApiDocumentation.APIKeyBase);
    });
