...
(function(root, factory) {
  ...
  describe('AssetApi', function() {
    ...
    describe('addSoftwaresToAsset', function() {
      it('should call addSoftwaresToAsset successfully', function(done) {
        //uncomment below and update the code to test addSoftwaresToAsset
        //instance.addSoftwaresToAsset(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSoftwaresOfSoftware', function() {
      it('should call getSoftwaresOfSoftware successfully', function(done) {
        //uncomment below and update the code to test getSoftwaresOfSoftware
        //instance.getSoftwaresOfSoftware(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('removeSoftwaresOfAsset', function() {
      it('should call removeSoftwaresOfAsset successfully', function(done) {
        //uncomment below and update the code to test removeSoftwaresOfAsset
        //instance.removeSoftwaresOfAsset(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('replaceSoftwaresOfAsset', function() {
      it('should call replaceSoftwaresOfAsset successfully', function(done) {
        //uncomment below and update the code to test replaceSoftwaresOfAsset
        //instance.replaceSoftwaresOfAsset(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
