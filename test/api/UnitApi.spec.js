...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.UnitApi();
  });
  ...
  describe('UnitApi', function() {
    describe('getUnitById', function() {
      it('should call getUnitById successfully', function(done) {
        //uncomment below and update the code to test getUnitById
        //instance.getUnitById(function(error) {
