...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NetilionApiDocumentation.APIKeyApi();
  });
  ...
  describe('APIKeyApi', function() {
    ...
    describe('getAPIKeyById', function() {
      it('should call getAPIKeyById successfully', function(done) {
        //uncomment below and update the code to test getAPIKeyById
        //instance.getAPIKeyById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
