...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ClientApplicationIDs', 'model/ClientApplicationPublicResponse', 'model/ClientApplicationRequest', 'model/ClientApplicationResponse', 'model/ClientApplicationsResponse', 'model/EdgeDeviceApplicationsResponse', 'model/ErrorResponse', 'model/UserIDs', 'model/UsersPublicResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ClientApplicationIDs'), require('../model/ClientApplicationPublicResponse'), require('../model/ClientApplicationRequest'), require('../model/ClientApplicationResponse'), require('../model/ClientApplicationsResponse'), require('../model/EdgeDeviceApplicationsResponse'), require('../model/ErrorResponse'), require('../model/UserIDs'), require('../model/UsersPublicResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.ClientApplicationApi = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.ClientApplicationIDs, root.NetilionApiDocumentation.ClientApplicationPublicResponse, root.NetilionApiDocumentation.ClientApplicationRequest, root.NetilionApiDocumentation.ClientApplicationResponse, root.NetilionApiDocumentation.ClientApplicationsResponse, root.NetilionApiDocumentation.EdgeDeviceApplicationsResponse, root.NetilionApiDocumentation.ErrorResponse, root.NetilionApiDocumentation.UserIDs, root.NetilionApiDocumentation.UsersPublicResponse);
  }
}(this, function(ApiClient, ClientApplicationIDs, ClientApplicationPublicResponse, ClientApplicationRequest, ClientApplicationResponse, ClientApplicationsResponse, EdgeDeviceApplicationsResponse, ErrorResponse, UserIDs, UsersPublicResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} edgeDeviceApplicationId Id of the edge device application to which the client applications will be added
     * @param {module:model/ClientApplicationIDs} body Resources that shall be added.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.addClientApplicationsToEdgeApplicationWithHttpInfo = function(edgeDeviceApplicationId, body) {
      var postBody = body;

      // verify the required parameter 'edgeDeviceApplicationId' is set
      if (edgeDeviceApplicationId === undefined || edgeDeviceApplicationId === null) {
        throw new Error("Missing the required parameter 'edgeDeviceApplicationId' when calling addClientApplicationsToEdgeApplication");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addClientApplicationsToEdgeApplication");
      }
     ...
     */
    this.addClientApplicationsToEdgeApplication = function(edgeDeviceApplicationId, body) {
      return this.addClientApplicationsToEdgeApplicationWithHttpInfo(edgeDeviceApplicationId, body)
     ...
     * @param {Number} edgeDeviceApplicationId The resource defined in the URL
     * @param {Object} opts Optional parameters
     * @param {Number} opts.page Page number to load
     * @param {Number} opts.perPage Number of items to load per page
     * @param {String} opts.include Comma separated list of objects to include in response
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ClientApplicationsResponse} and HTTP response
     */
    this.getClientApplicationsOfEdgeDeviceApplicationWithHttpInfo = function(edgeDeviceApplicationId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'edgeDeviceApplicationId' is set
      if (edgeDeviceApplicationId === undefined || edgeDeviceApplicationId === null) {
        throw new Error("Missing the required parameter 'edgeDeviceApplicationId' when calling getClientApplicationsOfEdgeDeviceApplication");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ClientApplicationsResponse}
     */
    this.getClientApplicationsOfEdgeDeviceApplication = function(edgeDeviceApplicationId, opts) {
     ...
     * @param {Number} clientApplicationId id of the client application to fetch
     * @param {Object} opts Optional parameters
     * @param {Number} opts.page Page number to load
     * @param {Number} opts.perPage Number of items to load per page
     * @param {String} opts.name Filter accepts &#x60;*&#x60; as wildcard
     * @param {String} opts.code Filter accepts &#x60;*&#x60; as wildcard
     * @param {String} opts.edgeDeviceTypeId One or multiple ids (comma list). Expected id format is integer
     ...
     */
    this.getEdgeDeviceApplicationsOfClientApplicationWithHttpInfo = function(clientApplicationId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'clientApplicationId' is set
      if (clientApplicationId === undefined || clientApplicationId === null) {
        throw new Error("Missing the required parameter 'clientApplicationId' when calling getEdgeDeviceApplicationsOfClientApplication");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = EdgeDeviceApplicationsResponse;
     ...
     */
    this.getEdgeDeviceApplicationsOfClientApplication = function(clientApplicationId, opts) {
     ...
     * @param {Number} edgeDeviceApplicationId Id of the edge device application from which the client applications will be removed
     * @param {module:model/ClientApplicationIDs} body Resources that shall be removed.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.removeClientApplicationsOfEdgeDeviceApplicationWithHttpInfo = function(edgeDeviceApplicationId, body) {
      var postBody = body;

      // verify the required parameter 'edgeDeviceApplicationId' is set
      if (edgeDeviceApplicationId === undefined || edgeDeviceApplicationId === null) {
        throw new Error("Missing the required parameter 'edgeDeviceApplicationId' when calling removeClientApplicationsOfEdgeDeviceApplication");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling removeClientApplicationsOfEdgeDeviceApplication");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.removeClientApplicationsOfEdgeDeviceApplication = function(edgeDeviceApplicationId, body) {
      return this.removeClientApplicationsOfEdgeDeviceApplicationWithHttpInfo(edgeDeviceApplicationId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} edgeDeviceApplicationId Id of the edge device application of which the client applications will be replaced
     * @param {module:model/ClientApplicationIDs} body Resources that shall be replaced
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.replaceClientApplicationsOfEdgeDeviceApplicationWithHttpInfo = function(edgeDeviceApplicationId, body) {
      var postBody = body;

      // verify the required parameter 'edgeDeviceApplicationId' is set
      if (edgeDeviceApplicationId === undefined || edgeDeviceApplicationId === null) {
        throw new Error("Missing the required parameter 'edgeDeviceApplicationId' when calling replaceClientApplicationsOfEdgeDeviceApplication");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling replaceClientApplicationsOfEdgeDeviceApplication");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.replaceClientApplicationsOfEdgeDeviceApplication = function(edgeDeviceApplicationId, body) {
      return this.replaceClientApplicationsOfEdgeDeviceApplicationWithHttpInfo(edgeDeviceApplicationId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
