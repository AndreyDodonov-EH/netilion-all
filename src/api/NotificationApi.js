...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getClientApplicationsOfNotificationWithHttpInfo = function(notificationId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'notificationId' is set
      if (notificationId === undefined || notificationId === null) {
        throw new Error("Missing the required parameter 'notificationId' when calling getClientApplicationsOfNotification");
      }
     ...
     */
    this.getClientApplicationsOfNotification = function(notificationId, opts) {
