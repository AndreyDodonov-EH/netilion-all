...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AssetIDs', 'model/AssetsResponse', 'model/DocumentIDs', 'model/DocumentsResponse', 'model/ErrorResponse', 'model/InstrumentationIDs', 'model/InstrumentationsResponse', 'model/NodeRequest', 'model/NodeResponse', 'model/NodeTypeResponse', 'model/NodeTypes', 'model/NodesResponse', 'model/PictureLinkRequest', 'model/PictureResponse', 'model/PicturesResponse', 'model/SpecificationsDelete', 'model/SpecificationsRename', 'model/SpecificationsRequest', 'model/SpecificationsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AssetIDs'), require('../model/AssetsResponse'), require('../model/DocumentIDs'), require('../model/DocumentsResponse'), require('../model/ErrorResponse'), require('../model/InstrumentationIDs'), require('../model/InstrumentationsResponse'), require('../model/NodeRequest'), require('../model/NodeResponse'), require('../model/NodeTypeResponse'), require('../model/NodeTypes'), require('../model/NodesResponse'), require('../model/PictureLinkRequest'), require('../model/PictureResponse'), require('../model/PicturesResponse'), require('../model/SpecificationsDelete'), require('../model/SpecificationsRename'), require('../model/SpecificationsRequest'), require('../model/SpecificationsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.NodeApi = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.AssetIDs, root.NetilionApiDocumentation.AssetsResponse, root.NetilionApiDocumentation.DocumentIDs, root.NetilionApiDocumentation.DocumentsResponse, root.NetilionApiDocumentation.ErrorResponse, root.NetilionApiDocumentation.InstrumentationIDs, root.NetilionApiDocumentation.InstrumentationsResponse, root.NetilionApiDocumentation.NodeRequest, root.NetilionApiDocumentation.NodeResponse, root.NetilionApiDocumentation.NodeTypeResponse, root.NetilionApiDocumentation.NodeTypes, root.NetilionApiDocumentation.NodesResponse, root.NetilionApiDocumentation.PictureLinkRequest, root.NetilionApiDocumentation.PictureResponse, root.NetilionApiDocumentation.PicturesResponse, root.NetilionApiDocumentation.SpecificationsDelete, root.NetilionApiDocumentation.SpecificationsRename, root.NetilionApiDocumentation.SpecificationsRequest, root.NetilionApiDocumentation.SpecificationsResponse);
  }
}(this, function(ApiClient, AssetIDs, AssetsResponse, DocumentIDs, DocumentsResponse, ErrorResponse, InstrumentationIDs, InstrumentationsResponse, NodeRequest, NodeResponse, NodeTypeResponse, NodeTypes, NodesResponse, PictureLinkRequest, PictureResponse, PicturesResponse, SpecificationsDelete, SpecificationsRename, SpecificationsRequest, SpecificationsResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.addNodePictureLinkWithHttpInfo = function(id, body) {
      var postBody = body;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling addNodePictureLink");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addNodePictureLink");
      }
     ...
     */
    this.addNodePictureLink = function(id, body) {
      return this.addNodePictureLinkWithHttpInfo(id, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} id Id of the node picture
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.deleteNodePictureWithHttpInfo = function(nodeId, id) {
      var postBody = null;

      // verify the required parameter 'nodeId' is set
      if (nodeId === undefined || nodeId === null) {
        throw new Error("Missing the required parameter 'nodeId' when calling deleteNodePicture");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteNodePicture");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.deleteNodePicture = function(nodeId, id) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.downloadNodePictureWithHttpInfo = function(nodeId, id) {
      var postBody = null;

      // verify the required parameter 'nodeId' is set
      if (nodeId === undefined || nodeId === null) {
        throw new Error("Missing the required parameter 'nodeId' when calling downloadNodePicture");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling downloadNodePicture");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.downloadNodePicture = function(nodeId, id) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PictureResponse} and HTTP response
     */
    this.getNodePictureWithHttpInfo = function(nodeId, id) {
      var postBody = null;

      // verify the required parameter 'nodeId' is set
      if (nodeId === undefined || nodeId === null) {
        throw new Error("Missing the required parameter 'nodeId' when calling getNodePicture");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getNodePicture");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PictureResponse}
     */
    this.getNodePicture = function(nodeId, id) {
     ...
     */
    this.getNodePicturesWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getNodePictures");
      }
     ...
     */
    this.getNodePictures = function(id, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PictureResponse} and HTTP response
     */
    this.updateNodePictureWithHttpInfo = function(nodeId, id, image) {
      var postBody = null;

      // verify the required parameter 'nodeId' is set
      if (nodeId === undefined || nodeId === null) {
        throw new Error("Missing the required parameter 'nodeId' when calling updateNodePicture");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateNodePicture");
      }

      // verify the required parameter 'image' is set
      if (image === undefined || image === null) {
        throw new Error("Missing the required parameter 'image' when calling updateNodePicture");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PictureResponse}
     */
    this.updateNodePicture = function(nodeId, id, image) {
      return this.updateNodePictureWithHttpInfo(nodeId, id, image)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PictureResponse} and HTTP response
     */
    this.updateNodePictureLinkWithHttpInfo = function(nodeId, id, body) {
      var postBody = body;

      // verify the required parameter 'nodeId' is set
      if (nodeId === undefined || nodeId === null) {
        throw new Error("Missing the required parameter 'nodeId' when calling updateNodePictureLink");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateNodePictureLink");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateNodePictureLink");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PictureResponse}
     */
    this.updateNodePictureLink = function(nodeId, id, body) {
      return this.updateNodePictureLinkWithHttpInfo(nodeId, id, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PictureResponse} and HTTP response
     */
    this.uploadNodePictureWithHttpInfo = function(id, image) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling uploadNodePicture");
      }

      // verify the required parameter 'image' is set
      if (image === undefined || image === null) {
        throw new Error("Missing the required parameter 'image' when calling uploadNodePicture");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PictureResponse}
     */
    this.uploadNodePicture = function(id, image) {
      return this.uploadNodePictureWithHttpInfo(id, image)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
