...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DocumentClassificationRequest', 'model/DocumentClassificationResponse', 'model/DocumentClassifications', 'model/ErrorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DocumentClassificationRequest'), require('../model/DocumentClassificationResponse'), require('../model/DocumentClassifications'), require('../model/ErrorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.DocumentClassificationApi = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.DocumentClassificationRequest, root.NetilionApiDocumentation.DocumentClassificationResponse, root.NetilionApiDocumentation.DocumentClassifications, root.NetilionApiDocumentation.ErrorResponse);
  }
}(this, function(ApiClient, DocumentClassificationRequest, DocumentClassificationResponse, DocumentClassifications, ErrorResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/DocumentClassificationRequest} body DocumentClassification object to create.
     ...
     */
    this.createDocumentClassificationWithHttpInfo = function(body) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createDocumentClassification");
      }
     ...
     */
    this.createDocumentClassification = function(body) {
     ...
     * @param {Number} id Id of the document classification to delete
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.deleteDocumentClassificationWithHttpInfo = function(id) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteDocumentClassification");
      }
     ...
     */
    this.deleteDocumentClassification = function(id) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DocumentClassificationResponse} and HTTP response
     */
    this.getDocumentClassificationByIdWithHttpInfo = function(id, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getDocumentClassificationById");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DocumentClassificationResponse}
     */
    this.getDocumentClassificationById = function(id, opts) {
     ...
     */
    this.getDocumentClassificationsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.getDocumentClassifications = function(opts) {
     ...
     * @param {Number} id Id of the document classification to update
     * @param {module:model/DocumentClassificationRequest} body Parameters that shall be updated.
     * @param {Object} opts Optional parameters
     * @param {String} opts.contentLanguage language of the content
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.updateDocumentClassificationWithHttpInfo = function(id, body, opts) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateDocumentClassification");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateDocumentClassification");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.updateDocumentClassification = function(id, body, opts) {
      return this.updateDocumentClassificationWithHttpInfo(id, body, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
