...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AssetIDs', 'model/AssetsResponse', 'model/ErrorResponse', 'model/SpecificationsDelete', 'model/SpecificationsRename', 'model/SpecificationsRequest', 'model/SpecificationsResponse', 'model/SubscriptionRequest', 'model/SubscriptionResponse', 'model/SubscriptionSeatPatch', 'model/SubscriptionSeatsResponse', 'model/SubscriptionsResponse', 'model/UserIDorEmails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AssetIDs'), require('../model/AssetsResponse'), require('../model/ErrorResponse'), require('../model/SpecificationsDelete'), require('../model/SpecificationsRename'), require('../model/SpecificationsRequest'), require('../model/SpecificationsResponse'), require('../model/SubscriptionRequest'), require('../model/SubscriptionResponse'), require('../model/SubscriptionSeatPatch'), require('../model/SubscriptionSeatsResponse'), require('../model/SubscriptionsResponse'), require('../model/UserIDorEmails'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.SubscriptionApi = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.AssetIDs, root.NetilionApiDocumentation.AssetsResponse, root.NetilionApiDocumentation.ErrorResponse, root.NetilionApiDocumentation.SpecificationsDelete, root.NetilionApiDocumentation.SpecificationsRename, root.NetilionApiDocumentation.SpecificationsRequest, root.NetilionApiDocumentation.SpecificationsResponse, root.NetilionApiDocumentation.SubscriptionRequest, root.NetilionApiDocumentation.SubscriptionResponse, root.NetilionApiDocumentation.SubscriptionSeatPatch, root.NetilionApiDocumentation.SubscriptionSeatsResponse, root.NetilionApiDocumentation.SubscriptionsResponse, root.NetilionApiDocumentation.UserIDorEmails);
  }
}(this, function(ApiClient, AssetIDs, AssetsResponse, ErrorResponse, SpecificationsDelete, SpecificationsRename, SpecificationsRequest, SpecificationsResponse, SubscriptionRequest, SubscriptionResponse, SubscriptionSeatPatch, SubscriptionSeatsResponse, SubscriptionsResponse, UserIDorEmails) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} subscriptionId Id of the subscription to which the user will be added
     * @param {module:model/UserIDorEmails} body Resources that shall be added.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.addSeatUsersToSubscriptionWithHttpInfo = function(subscriptionId, body) {
      var postBody = body;

      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling addSeatUsersToSubscription");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addSeatUsersToSubscription");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.addSeatUsersToSubscription = function(subscriptionId, body) {
      return this.addSeatUsersToSubscriptionWithHttpInfo(subscriptionId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} id Id of the subscription seat
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.deleteSubscriptionSeatWithHttpInfo = function(id) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteSubscriptionSeat");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.deleteSubscriptionSeat = function(id) {
     ...
     * @param {String} opts.status one or multiple statuses (comma list). Allowed values are &#x60;pending&#x60;, &#x60;invited&#x60;, &#x60;accepted&#x60;
     ...
     */
    this.getSeatUsersOfSubscriptionWithHttpInfo = function(subscriptionId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling getSeatUsersOfSubscription");
      }
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = SubscriptionSeatsResponse;
     ...
     */
    this.getSeatUsersOfSubscription = function(subscriptionId, opts) {
     ...
     * @param {Number} opts.userId One or multiple ids (comma list). Expected id format is integer
     * @param {String} opts.status one or multiple statuses (comma list). Allowed values are &#x60;pending&#x60;, &#x60;invited&#x60;, &#x60;accepted&#x60;
     * @param {Number} opts.clientApplicationId Expected id format is integer
     * @param {String} opts.orderBy Order result by attribute value, accepts &#x60;id&#x60;, &#x60;created_at&#x60; or &#x60;updated_at&#x60;. Add &#x60;-&#x60; as a prefix for descending order. Default value is &#x60;id&#x60;
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/SubscriptionSeatsResponse} and HTTP response
     */
    this.getSubscriptionSeatsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/SubscriptionSeatsResponse}
     */
    this.getSubscriptionSeats = function(opts) {
     ...
     * @param {Number} subscriptionId Id of the subscription from which the user will be removed
     * @param {module:model/UserIDorEmails} body Resources that shall be removed.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.removeSeatUsersFromSubscriptionWithHttpInfo = function(subscriptionId, body) {
      var postBody = body;

      // verify the required parameter 'subscriptionId' is set
      if (subscriptionId === undefined || subscriptionId === null) {
        throw new Error("Missing the required parameter 'subscriptionId' when calling removeSeatUsersFromSubscription");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling removeSeatUsersFromSubscription");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.removeSeatUsersFromSubscription = function(subscriptionId, body) {
      return this.removeSeatUsersFromSubscriptionWithHttpInfo(subscriptionId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} id Id of the subscription seat to update
     * @param {module:model/SubscriptionSeatPatch} body Parameters that shall be updated.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.updateSubscriptionSeatWithHttpInfo = function(id, body) {
      var postBody = body;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateSubscriptionSeat");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateSubscriptionSeat");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.updateSubscriptionSeat = function(id, body) {
      return this.updateSubscriptionSeatWithHttpInfo(id, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
