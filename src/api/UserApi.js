...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessRightsResponse', 'model/CurrentUserResponse', 'model/DataExportRequest', 'model/DataExportResponse', 'model/DataExportsResponse', 'model/ErrorResponse', 'model/Notifications', 'model/SignInsResponse', 'model/SpecificationsDelete', 'model/SpecificationsRename', 'model/SpecificationsRequest', 'model/SpecificationsResponse', 'model/TechnicalUserCreateResponse', 'model/TechnicalUserPasswordResponse', 'model/TechnicalUserRequest', 'model/TechnicalUsersResponse', 'model/UsageResponse', 'model/UserChangeRequest', 'model/UserGroupIDs', 'model/UserGroupsWithUsers', 'model/UserPublicResponse', 'model/UserResponse', 'model/UserRoleIDs', 'model/UserRolesResponse', 'model/UsersResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AccessRightsResponse'), require('../model/CurrentUserResponse'), require('../model/DataExportRequest'), require('../model/DataExportResponse'), require('../model/DataExportsResponse'), require('../model/ErrorResponse'), require('../model/Notifications'), require('../model/SignInsResponse'), require('../model/SpecificationsDelete'), require('../model/SpecificationsRename'), require('../model/SpecificationsRequest'), require('../model/SpecificationsResponse'), require('../model/TechnicalUserCreateResponse'), require('../model/TechnicalUserPasswordResponse'), require('../model/TechnicalUserRequest'), require('../model/TechnicalUsersResponse'), require('../model/UsageResponse'), require('../model/UserChangeRequest'), require('../model/UserGroupIDs'), require('../model/UserGroupsWithUsers'), require('../model/UserPublicResponse'), require('../model/UserResponse'), require('../model/UserRoleIDs'), require('../model/UserRolesResponse'), require('../model/UsersResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.UserApi = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.AccessRightsResponse, root.NetilionApiDocumentation.CurrentUserResponse, root.NetilionApiDocumentation.DataExportRequest, root.NetilionApiDocumentation.DataExportResponse, root.NetilionApiDocumentation.DataExportsResponse, root.NetilionApiDocumentation.ErrorResponse, root.NetilionApiDocumentation.Notifications, root.NetilionApiDocumentation.SignInsResponse, root.NetilionApiDocumentation.SpecificationsDelete, root.NetilionApiDocumentation.SpecificationsRename, root.NetilionApiDocumentation.SpecificationsRequest, root.NetilionApiDocumentation.SpecificationsResponse, root.NetilionApiDocumentation.TechnicalUserCreateResponse, root.NetilionApiDocumentation.TechnicalUserPasswordResponse, root.NetilionApiDocumentation.TechnicalUserRequest, root.NetilionApiDocumentation.TechnicalUsersResponse, root.NetilionApiDocumentation.UsageResponse, root.NetilionApiDocumentation.UserChangeRequest, root.NetilionApiDocumentation.UserGroupIDs, root.NetilionApiDocumentation.UserGroupsWithUsers, root.NetilionApiDocumentation.UserPublicResponse, root.NetilionApiDocumentation.UserResponse, root.NetilionApiDocumentation.UserRoleIDs, root.NetilionApiDocumentation.UserRolesResponse, root.NetilionApiDocumentation.UsersResponse);
  }
}(this, function(ApiClient, AccessRightsResponse, CurrentUserResponse, DataExportRequest, DataExportResponse, DataExportsResponse, ErrorResponse, Notifications, SignInsResponse, SpecificationsDelete, SpecificationsRename, SpecificationsRequest, SpecificationsResponse, TechnicalUserCreateResponse, TechnicalUserPasswordResponse, TechnicalUserRequest, TechnicalUsersResponse, UsageResponse, UserChangeRequest, UserGroupIDs, UserGroupsWithUsers, UserPublicResponse, UserResponse, UserRoleIDs, UserRolesResponse, UsersResponse) {
  'use strict';
