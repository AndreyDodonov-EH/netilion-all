...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} assetId Id of the asset to which the software will be added
     * @param {module:model/SoftwareIDs} body Resources that shall be added.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.addSoftwaresToAssetWithHttpInfo = function(assetId, body) {
      var postBody = body;

      // verify the required parameter 'assetId' is set
      if (assetId === undefined || assetId === null) {
        throw new Error("Missing the required parameter 'assetId' when calling addSoftwaresToAsset");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling addSoftwaresToAsset");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.addSoftwaresToAsset = function(assetId, body) {
      return this.addSoftwaresToAssetWithHttpInfo(assetId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.getSoftwaresOfSoftwareWithHttpInfo = function(assetId, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'assetId' is set
      if (assetId === undefined || assetId === null) {
        throw new Error("Missing the required parameter 'assetId' when calling getSoftwaresOfSoftware");
      }
     ...
     */
    this.getSoftwaresOfSoftware = function(assetId, opts) {
     ...
     * @param {Number} assetId Id of the product from which the software will be removed
     * @param {module:model/SoftwareIDs} body Resources that shall be removed.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.removeSoftwaresOfAssetWithHttpInfo = function(assetId, body) {
      var postBody = body;

      // verify the required parameter 'assetId' is set
      if (assetId === undefined || assetId === null) {
        throw new Error("Missing the required parameter 'assetId' when calling removeSoftwaresOfAsset");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling removeSoftwaresOfAsset");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.removeSoftwaresOfAsset = function(assetId, body) {
      return this.removeSoftwaresOfAssetWithHttpInfo(assetId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Number} assetId Id of the asset of which the software will be replaced
     * @param {module:model/SoftwareIDs} body Resources that shall be replaced
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.replaceSoftwaresOfAssetWithHttpInfo = function(assetId, body) {
      var postBody = body;

      // verify the required parameter 'assetId' is set
      if (assetId === undefined || assetId === null) {
        throw new Error("Missing the required parameter 'assetId' when calling replaceSoftwaresOfAsset");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling replaceSoftwaresOfAsset");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.replaceSoftwaresOfAsset = function(assetId, body) {
      return this.replaceSoftwaresOfAssetWithHttpInfo(assetId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
