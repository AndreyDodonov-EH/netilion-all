...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NetilionApiDocumentation.RequestUser = factory(root.NetilionApiDocumentation.ApiClient);
  }
   ...
   * @class
   * @param id {Number} id of the request user
   * @param href {String} href to the request user
   * @param email {String} email of the request user
   */
