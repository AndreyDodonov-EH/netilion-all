...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Links10', 'model/NestedIDHref', 'model/NodeBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Links10'), require('./NestedIDHref'), require('./NodeBase'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.NodeResponse = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.Links10, root.NetilionApiDocumentation.NestedIDHref, root.NetilionApiDocumentation.NodeBase);
  }
}(this, function(ApiClient, Links10, NestedIDHref, NodeBase) {
  'use strict';
