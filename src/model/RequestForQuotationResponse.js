...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Links14', 'model/NestedIDHref', 'model/RequestForQuotationBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Links14'), require('./NestedIDHref'), require('./RequestForQuotationBase'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.RequestForQuotationResponse = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.Links14, root.NetilionApiDocumentation.NestedIDHref, root.NetilionApiDocumentation.RequestForQuotationBase);
  }
}(this, function(ApiClient, Links14, NestedIDHref, RequestForQuotationBase) {
  'use strict';
