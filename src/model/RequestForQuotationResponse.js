...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Links17', 'model/NestedIDHref', 'model/RequestForQuotationBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Links17'), require('./NestedIDHref'), require('./RequestForQuotationBase'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.RequestForQuotationResponse = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.Links17, root.NetilionApiDocumentation.NestedIDHref, root.NetilionApiDocumentation.RequestForQuotationBase);
  }
}(this, function(ApiClient, Links17, NestedIDHref, RequestForQuotationBase) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('links')) {
        obj['links'] = Links17.constructFromObject(data['links']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Links17} links
   */
