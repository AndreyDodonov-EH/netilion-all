...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Links13', 'model/NestedIDHref', 'model/ProductLineItem', 'model/QuotationBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Links13'), require('./NestedIDHref'), require('./ProductLineItem'), require('./QuotationBase'));
  } else {
    // Browser globals (root is window)
    if (!root.NetilionApiDocumentation) {
      root.NetilionApiDocumentation = {};
    }
    root.NetilionApiDocumentation.QuotationResponse = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.Links13, root.NetilionApiDocumentation.NestedIDHref, root.NetilionApiDocumentation.ProductLineItem, root.NetilionApiDocumentation.QuotationBase);
  }
}(this, function(ApiClient, Links13, NestedIDHref, ProductLineItem, QuotationBase) {
  'use strict';
