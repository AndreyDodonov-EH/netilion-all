...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NetilionApiDocumentation.Links = factory(root.NetilionApiDocumentation.ApiClient, root.NetilionApiDocumentation.Link);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('edge_devices')) {
        obj['edge_devices'] = Link.constructFromObject(data['edge_devices']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Link} edge_devices
   */
